...
public class RecipeRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        switch (i){
            ...
            case EXHAUSTED_TYPE:
                view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.layout_search_exhausted,
                        viewGroup, false);
                return new SeachExhaustedViewHolder(view);
            default:
                view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.layout_recipe_list_item,
                        viewGroup, false);
                return new RecipeViewHolder(view, mOnRecipeListener);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        ...
        if (itemViewType==RECIPE_TYPE){
            ...
            Uri path = Uri.parse("android.resource://expencive.vk.com.recipes/drawable/" + mRecipes.get(i).getImage_url());
